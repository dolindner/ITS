...
if __name__ == "__main__":
    ...
    from equiadapt import RotationEquivariantConv
    ...
    # Instantiate layers
    equiv = RotationEquivariantConv(int(Cin / math.sqrt(1)), int(Cout / math.sqrt(1)), 3, num_rotations=num_rotations,
                                    padding=1, device=device).eval().cuda()
