...
class TransformationProblem:
    def __init__(self, confidence_module, transform_sequence: TransformSequence,
                 consolidate_method="consolidate_simple", max_batch_size=None):
        """
    ...
    def matrix_dim(self) -> int:
        ...
        dummy_param = torch.zeros(1, param_dim, device=self.transform_sequence.dummy_param.device,
                                  dtype=self.transform_sequence.dummy_param.dtype)
